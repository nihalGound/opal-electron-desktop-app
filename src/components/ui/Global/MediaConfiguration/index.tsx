...
const MediaConfigration = ({state,user}: Props) => {
    ...
    return (
        <form className="flex h-full relative w-full flex-col gap-y-5">
            {isPending && (<div className="fixed z-50 w-full top-0 left-0 right-0 bottom-0 rounded-2xl h-full bg-black/80 flexx justify-center items-center">
                <Loader />
            </div>)}
...
export default MediaConfigration